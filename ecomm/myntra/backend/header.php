...
<body>
  <div>
  <h1 style="font-size:26px;margin-top:100px; margin-left:50px;">Hello, <?php echo $_SESSION['name']; ?></h1>
  </div>
  <div class="imp">
...
<li class="dropdown hv5">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <li class="dropdown-item" style="font-size:11px;font-weight:800;"><h1 style="font-size:16px;">Hello, <?php echo $_SESSION['name']; ?></h1>
<br>to access account and manage orders
    
  </li> <a href="logout.php" class="bt1">
  <button class="dropdown-item bt2 ">LOGOUT</button>  </a>
